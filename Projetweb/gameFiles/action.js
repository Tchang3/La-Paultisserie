...
var knife = new Weapon("knife",70,0.7,20,120,50,'gameFiles/weaponImages/knife.png',0,0);
	...
	if(win == 1) {
		...
		if(transRect*4/5<1000) {
			...
			if(niveau == 1) {
				...
				bgm.play();
				var enemy = new Entity('dragon','gameFiles/entityImages/DRAGON.png',2000,2000,300,5,491*2,306*2,800,180,true);
				entityList.push(enemy);
			} else {
				bgm.stop();
